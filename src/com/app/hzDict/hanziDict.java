...
public class hanziDict {
	...
	public static void main(String[] args) {
		char ch = '郑';
		System.out.println(ch + "的拼音（中式注音）为：" + hanziDict.getPY(ch, true));
		System.out.println(ch + "的拼音（英式注音）为：" + hanziDict.getPY(ch, false));
		System.out.println(ch + "的部首为　　　　　　：" + hanziDict.getBS(ch));
		System.out.println(ch + "的部首笔画为　　　　：" + hanziDict.getBH(hanziDict.getBS(ch)));
		System.out.println(ch + "的笔画顺序为　　　　：" + hanziDict.getBH(ch));
		System.out.println(ch + "的笔画数为　　　　　：" + hanziDict.getBH(ch).length());
		System.out.println();
		ch = '大';
		System.out.println(ch + "的拼音（中式注音）为：" + hanziDict.getPY(ch, true));
		System.out.println(ch + "的拼音（英式注音）为：" + hanziDict.getPY(ch, false));
